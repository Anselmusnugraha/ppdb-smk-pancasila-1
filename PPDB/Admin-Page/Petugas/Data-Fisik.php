...
<!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="Data-Fisik.php">Data Seleksi Fisik</a>
        </li>
 ...
 <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Seleksi Fisik</div>
        <div class="card-body">
 ...
 -webkit-transform:scale(1.1);
  transform:scale(1.1); 
            ...
            <table class="table table-bordered table-a" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
          <?php 
            $sql="select biodata_calsiswa.nama, fisik.id_fisik, fisik.berat_badan, fisik.tinggi_badan, fisik.tato_tindik from biodata_calsiswa inner join pendaftaran on biodata_calsiswa.no_pendaftaran=pendaftaran.no_pendaftaran inner join seleksi on seleksi.no_pendaftaran=pendaftaran.no_pendaftaran inner join fisik on fisik.id_fisik=seleksi.id_fisik";
            $query = mysql_query($sql);
            while ($View=mysql_fetch_array($query)) {
            $ID_FISIK = $View['id_fisik'];              
          ?> 
                <tr>
                  <td><?php echo $View['nama']; ?></td>
                  <td><?php echo $View['berat_badan']; ?></td>
                  <td><?php echo $View['tinggi_badan']; ?></td>
                  <td><?php echo $View['tato_tindik']; ?></td>
                  <td>
                    <a href="#" class='OpenModal' id='<?php echo $ID_FISIK ?>'><button class="butEdit"><i class="fa fa-edit"></i></button></a>
                    <a href="#" onclick="confirm_modal('DELETE/delete-fisik.php?&id_fisik=<?php echo  $View['id_fisik']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
