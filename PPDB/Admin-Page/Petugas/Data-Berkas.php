  ...
  transform:scale(1.1); 
          ...
          ?> 
                <tr>
                  ...
                  <td><?php echo "<img src='../../Controller/SimpanData/".$View['Foto']."' width='200' height='170'>"; ?></td>
                  <td><?php echo "<img src='../../Controller/SimpanData/".$View['kk']."' width='200' height='170'>"; ?></td>
                  <td><?php echo "<img src='../../Controller/SimpanData/".$View['skhu_skhus']."' width='200' height='170'>"; ?></td>
                  <td><?php echo "<img src='../../Controller/SimpanData/".$View['ijazah']."' width='200' height='170'>"; ?></td>
                  <td><?php echo "<img src='../../Controller/SimpanData/".$View['srtf_piagam']."' width='200' height='170'>";?></td>
                  <td>
                  <!--  <a href="#"><button class="butEdit"><i class="fa fa-edit"></i></button></a> -->
                    <a href="#" onclick="confirm_modal('DELETE/delete-berkas.php?&id_detBerkas=<?php echo  $View['id_detBerkas']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
