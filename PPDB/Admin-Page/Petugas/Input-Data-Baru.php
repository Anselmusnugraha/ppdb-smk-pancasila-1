...
<form class="form-horizontal" action="SIMPAN-DATA/Controller-Simpan/Simpan-Data-All-Siswa.php" method="post" id="FormValidation" enctype="multipart/form-data">
  <div class="col-md-12">
  ...
  <div class="col-md-12">
    <div align="center" style="margin: 20px; padding: 5px;">
      ...
      <a href="index-Petugas.php"><button class="btn btn-default buttonRes" type="button">Cancel <i class="fa fa-remove"></i></button></a>
    </div>
  </div>
</form>
    <!-- /.container-fluid-->
