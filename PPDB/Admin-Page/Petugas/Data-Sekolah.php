          ...
          ?> 
                <tr>
                  ...
                  <td>
                    ...
                    <a href="#" onclick="confirm_modal('DELETE/delete-sekolah.php?&id_datSekolah=<?php echo  $View['id_datSekolah']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "EDIT-DATA/Edit-datSekolah.php",
             type: "GET",
