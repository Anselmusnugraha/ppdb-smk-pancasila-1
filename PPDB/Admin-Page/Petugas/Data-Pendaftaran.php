    ...
    border-radius: 7px;
          ...
          ?>
                <tr>
                  ...
                  <td>
                    <a href="#" onclick="confirm_modal('DELETE/delete-pendaftaran.php?&no_pendaftaran=<?php echo  $View['no_pendaftaran']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
