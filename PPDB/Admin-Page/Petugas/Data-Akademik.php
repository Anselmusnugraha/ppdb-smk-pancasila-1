...
<!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="Data-Akademik.php">Data Seleksi Akademik</a>
        </li>
 ...
 <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Seleksi Akademik</div>
        <div class="card-body">
 ...
 -webkit-transform:scale(1.1);
  transform:scale(1.1); 
            ...
            <table class="table table-bordered table-a" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
          <?php 
            $sql="select biodata_calsiswa.nama, akademik.id_akademik, akademik.B_indonesia, akademik.B_inggris, akademik.Matematika, akademik.IPA, akademik.na_skhu, akademik.tes_khusus, akademik.na_teskhusus from biodata_calsiswa inner join pendaftaran on biodata_calsiswa.no_pendaftaran=pendaftaran.no_pendaftaran inner join seleksi on seleksi.no_pendaftaran=pendaftaran.no_pendaftaran inner join akademik on akademik.id_akademik=seleksi.id_akademik";
            $query = mysql_query($sql);
            while ($View=mysql_fetch_array($query)) {
            $ID_AKD = $View['id_akademik'];              
          ?> 
                <tr>
                  ...
                  <td>
                    <a href="#" class='OpenModal' id='<?php echo $ID_AKD ?>'><button class="butEdit"><i class="fa fa-edit"></i></button></a>
                    <a href="#" onclick="confirm_modal('DELETE/delete-akademik.php?&id_akademik=<?php echo  $View['id_akademik']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "EDIT-DATA/Edit-Akademik.php",
             type: "GET",
             data : {id_akademik: m,},
