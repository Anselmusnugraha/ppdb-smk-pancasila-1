...
<!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="Data-Ortu.php">Data Ortu/Wali</a>
        </li>
...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Ortu/Wali</div>
        <div class="card-body">
 ...
 -webkit-transform:scale(1.1);
  transform:scale(1.1); 
            ...
            <table class="table table-bordered table-a" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
          <?php 
            $sql="select biodata_calsiswa.nama, ortu_wali.id_OrtuWali, ortu_wali.nama_ayah, ortu_wali.nama_ibu, ortu_wali.nama_wali, ortu_wali.pek_ayah, ortu_wali.pek_ibu, ortu_wali.pek_wali, ortu_wali.alamat_ortu, ortu_wali.no_telp_ortu from ortu_wali inner join biodata_calsiswa on ortu_wali.id_OrtuWali=biodata_calsiswa.id_OrtuWali";
            $query = mysql_query($sql);
            while ($View=mysql_fetch_array($query)) {
            $ID_ORT = $View['id_OrtuWali'];              
          ?> 
                <tr>
                  ...
                  <td>
                    <a href="#" class='OpenModal' id='<?php echo $ID_ORT ?>'><button class="butEdit"><i class="fa fa-edit"></i></button></a>
                    <a href="#" onclick="confirm_modal('DELETE/delete-ortu.php?&id_OrtuWali=<?php echo  $View['id_OrtuWali']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
