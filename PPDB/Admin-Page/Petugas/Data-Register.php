...
<!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="Data-Register.php">Data Registrasi</a>
        </li>
...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Registrasi</div>
        <div class="card-body">
  ...
  transform:scale(1.1); 
          ...
          <?php 
            ...
            while ($View=mysql_fetch_array($query)) {
              $ID_REG = $View['id_reg']; 
              $sql2="select * from biodata_calsiswa where id_reg=$ID_REG";
          ...
          ?> 
                <tr>
                  ...
                  <td>
                    <a href="#" class='OpenModal' id='<?php echo $View['id_reg']; ?>'><button class='butEdit' id='Edit'><i class='fa fa-edit'></i></button></a>
                    <a href="#" onclick="confirm_modal('DELETE/delete-register.php?&id_reg=<?php echo  $View['id_reg']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "EDIT-DATA/Edit-Register.php",
             type: "GET",
             data : {id_reg: m,},
