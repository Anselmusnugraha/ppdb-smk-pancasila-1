  ...
  transform:scale(1.1);
          ...
          ?>
                <tr>
                  ...
                  <td>
                    <a href="#" class='<?php if (mysql_num_rows($query2)>0) {?> ModalInfo <?php }else{?> OpenModal <?php } ?>' id='<?php echo $View['no_pendaftaran'] ?>'><button class="butInput" <?php if (mysql_num_rows($query2)>0) {?> disabled <?php } ?> ><i class="fa fa-pencil"></i></button></a>
                  <!--  <a href="#"><button class="butEdit"><i class="fa fa-edit"></i></button></a> -->
                    <a href="#" onclick="confirm_modal('DELETE/delete-seleksi.php?&id_seleksi=<?php while ($ID_iki=mysql_fetch_array($query2)) {echo  $ID_iki['id_seleksi']; } ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a> 
                  </td>
                </tr>
          <?php } ?>  
              </tbody>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "SIMPAN-DATA/Input-Nilai-Seleksi.php",
             type: "GET",
