...
<!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="Data-Sekolah.php">Data Asal Sekolah</a>
        </li>
 ...
 <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Asal Sekolah</div>
        <div class="card-body">
...
<a href="#"><button class="AddSkh" data-toggle="modal" data-target="#modalAddSekolah"><i class="fa fa-plus"></i> Tambah Sekolah</button></a>
          ...
          <?php 
            ...
            while ($View=mysql_fetch_array($query)) {
              $ID_AS = $View['id_asal_sekolah'];             
          ?> 
                <tr>
                  <td><?php echo $View['nama_sekolah']; ?></td>
                  <td>
                    <a href="#" class='OpenModal' id='<?php echo $View['id_asal_sekolah']; ?>'><button class='butEdit' id='Edit'><i class='fa fa-edit'></i></button></a>
                    <a href="#" onclick="confirm_modal('DELETE/delete-sekolah.php?&id_asal_sekolah=<?php echo  $View['id_asal_sekolah']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "EDIT-DATA/Edit-Sekolah.php",
             type: "GET",
             data : {id_asal_sekolah: m,},
...
<!-- Modal Add Petugas -->
<?php   
  $sql2="select * FROM asal_sekolah;";
  $query2=mysql_query($sql2); 
?>  
<div class="modal fade" id="modalAddSekolah" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->  
            <div class="modal-header" style="background-color: #DDDDDD;">
                <h3 class="modal-title"  id="myModalLabel" style="text-align: center;">Tambah Sekolah <i class="fa fa-pencil"></i></h3>
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form role="form" id="FormValidation" method="post" action="SIMPAN-DATA/Proses-Simpan-Sekolah.php">
                <input type="hidden" name="id_asal_sekolah" value=<?php echo $query2; ?>>
                    
                    <div class="form-group">
                      <label for="nama_sekolah" class="labelfrm">Nama Sekolah</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-university"></span></span>
                          <input id="nama_sekolah" class="form-control" type="text" placeholder="Nama Sekolah" name="nama_sekolah" required="true" autocomplete="off">
                        </div>
                    </div>
