          ...
          ?> 
                <tr>
                  ...
                  <td>
                    ...
                    <a href="#" onclick="confirm_modal('../../Petugas/DELETE/delete-register.php?&id_reg=<?php echo  $View['id_reg']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "../../Petugas/EDIT-DATA/Edit-Register.php",
             type: "GET",
             data : {id_reg: m,},
