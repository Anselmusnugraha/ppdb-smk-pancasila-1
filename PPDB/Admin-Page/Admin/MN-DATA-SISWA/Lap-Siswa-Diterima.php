 ...
 <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Laporan Siswa Diterima/Lolos</div>
        <div class="card-body">
...
<a href="../../../Laporan/Report-Siswa-Diterima.php"><button class="AddPtg"><i class="fa fa-print"></i> Cetak Laporan</button></a>
