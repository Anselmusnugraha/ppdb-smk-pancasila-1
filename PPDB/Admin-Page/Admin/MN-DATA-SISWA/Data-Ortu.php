          ...
          ?> 
                <tr>
                  ...
                  <td>
                    ...
                    <a href="#" onclick="confirm_modal('proses_delete.php?&id_OrtuWali=<?php echo  $View['id_OrtuWali']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "../../Petugas/EDIT-DATA/Edit-Ortu.php",
             type: "GET",
             data : {id_OrtuWali: m,},
