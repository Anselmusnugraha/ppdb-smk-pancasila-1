...
<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Sekolah</div>
        <div class="card-body">
 ...
 -webkit-transform:scale(1.1);
  transform:scale(1.1); 
            ...
            <table class="table table-bordered table-a" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
          <?php 
            $sql="select biodata_calsiswa.nama, asal_sekolah.nama_sekolah, data_sekolah.id_datSekolah, data_sekolah.nisn, data_sekolah.no_un, data_sekolah.no_ijazah, data_sekolah.tgl_ijazah from asal_sekolah inner join data_sekolah on asal_sekolah.id_asal_sekolah=data_sekolah.id_asal_sekolah inner join biodata_calsiswa on data_sekolah.id_datSekolah=biodata_calsiswa.id_datSekolah";
          ...
          ?> 
                <tr>
                  ...
                  <td><?php echo $View['no_ijazah']; ?></td>
                  <td><?php echo $View['tgl_ijazah']; ?></td>
                  <td>
                    <a href="#" class='OpenModal' id='<?php echo $View['id_datSekolah'] ?>'><button class="butEdit"><i class="fa fa-edit"></i></button></a>
                    <a href="#" onclick="confirm_modal('proses_delete.php?&id_datSekolah=<?php echo  $View['id_datSekolah']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "../../Petugas/EDIT-DATA/Edit-datSekolah.php",
             type: "GET",
             data : {id_datSekolah: m,},
