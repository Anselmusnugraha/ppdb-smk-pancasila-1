 ...
 <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Laporan Siswa Tidak diterima/Tidak Lolos</div>
        <div class="card-body">
...
<a href="../../../Laporan/Report-Siswa-Tdk-Diterima.php"><button class="AddPtg"><i class="fa fa-print"></i> Cetak Laporan</button></a>
<!-- <button class="AddPtg" data-toggle="modal" data-target="#modalViewTgl"><i class="fa fa-calendar"></i> View Dari Tanggal</button> -->
            <table class="table table-bordered table-a" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
          <?php 
            $sql="select seleksi.hasil, biodata_calsiswa.nama, biodata_calsiswa.jurusan, pendaftaran.no_pendaftaran from seleksi inner join pendaftaran on seleksi.no_pendaftaran=pendaftaran.no_pendaftaran inner join biodata_calsiswa on pendaftaran.no_pendaftaran=biodata_calsiswa.no_pendaftaran and (seleksi.hasil like 'Tidak%')";
          ...
          ?> 
                <tr>
                  ...
                  <td>
               <!--     <a href="#" class='OpenModal' id='<?php echo $View['']; ?>'><button class="butEdit"><i class="fa fa-edit"></i></button></a> -->
                    <a href="#" onclick="confirm_modal('proses_delete.php?&id_calSiswa=<?php echo  $View['id_calSiswa']; ?>');"><button class="butDelete"><i class="fa fa-trash"></i></button></a>
                  </td>
                </tr>
            <?php } ?>  
              </tbody>
...
<!-- TAMBAH PETUGAS -->
<!-- Modal Add Petugas -->
<!--<div class="modal fade" id="modalViewTgl" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">-->
            <!-- Modal Header -->  
<!--            <div class="modal-header" style="background-color: #b9c9fe;">
                <h3 class="modal-title"  id="myModalLabel" style="text-align: center;">View Dengan Tanggal Daftar <i class="fa fa-pencil"></i></h3>
...
<!--            <div class="modal-body">
                ...
                <form role="form" id="FormValidation" method="post" action="SIMPAN-DATA/Proses-Simpan-Petugas.php">
                    ...
                    <div class="form-group">
                      <label for="dr_tgl" class="labelfrm">Dari Tanggal</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-calendar"></span></span>
                          <input id="dr_tgl" class="form-control" type="date" name="dr_tgl" required="true" autocomplete="off">
                        </div>
                    </div>

                    <div class="form-group">
                      <label for="sm_tgl" class="labelfrm">Sampai Tanggal</label>
                        <div class="input-group">
                          <span class="input-group-addon" id="basic-addon1"><span class="fa fa-calendar"></span></span>
                          <input id="sm_tgl" class="form-control" type="date" name="sm_tgl" required="true" autocomplete="off">
                        </div>
                    </div>

                  <div class="modal-footer">
            <button type="submit" class="btn btn-primary  buttonLog">View <i class="fa fa-check"></i></button></a>
...
<script type="text/javascript">
   ...
   $(".OpenModal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "../../Petugas/EDIT-DATA/Edit-CalSiswa.php",
             type: "GET",
             data : {id_calSiswa: m,},
